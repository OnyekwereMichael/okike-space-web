...
//                   className="placeholder-[#8989894D] placeholder:text-[12px] leading-[100%] tracking-[1] placeholder:font-[400] font-inter-Regular text-[14px] text-black border-[1px] border-[#E2E2E2] rounded-[16px] px-2 h-[50px] w-full py-2 outline-none"
//                 />
//               </div>
...
//             {/* Confirm Password */}
//             <div>
//               <label className="block text-sm mb-[7px] font-inter-Regular text-[#0B0B0B] leading-[100%] tracking-[1] font-medium">
//                 Confirm Password
//               </label>
//               <div className="relative">
//                 <input
