    ...
    <div className="flex flex-col sm:flex-row sm:justify-between  items-stretch sm:items-center mt-8 bg-white rounded-[5px] overflow-hidden text-black w-full max-w-[692px] px-[8px] max-sm:pb-3">
      ...
      <div className="relative flex items-center w-full sm:w-[16rem] h-[52px] mb-2 sm:mb-0">
        ...
        <input
          ...
          className="pl-10 w-full h-full outline-none text-[18px] font-inter-Regular placeholder:leading-[36px] placeholder:font-inter-Regular placeholder:font-[400] placeholder:text-[18px] placeholder:text-[#BDBDBD] max-sm:placeholder:text-[14px] "
        />
      </div>
      ...
      <div className="relative flex items-center w-full sm:w-[12rem] h-[52px] border-t sm:border-t-0 sm:border-l border-[#ECECEC] sm:ml-2 pl-2">
        ...
        <input
          ...
          className="pl-10 pr-4 w-full h-full outline-none text-[18px] font-inter-Regular placeholder:leading-[36px] placeholder:font-inter-Regular placeholder:font-[400] placeholder:text-[18px] placeholder:text-[#BDBDBD] max-sm:placeholder:text-[14px] "
        />
      </div>
</div>
      {/* Button */}
