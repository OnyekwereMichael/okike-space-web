  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className="mb-4 font-clash-SemiBold text-[#1C1C1E] text-[60px] leading-[1.1] max-sm:text-[30px] max-sm:w-full max-sm:leading-9 max-xl:text-[45px] max-xl:leading-14 max-xm:mt-4">
