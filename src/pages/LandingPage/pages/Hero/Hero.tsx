...
<div className="absolute inset-0 hidden max-xl:flex max-sm:hidden justify-between pointer-events-none h-full">
  {[...Array(17)].map((_, idx) => (
    <div
      key={idx}
  ...
  {[...Array(7)].map((_, idx) => (
    ...
    />
        ...
        <div className="absolute inset-0 flex flex-col items-center text-center px-4 max-sm:px-3">
          <div className="bg-[#FFFFFF1A] px-[15px] h-[46px] flex justify-center items-center font-[400] py-[8px] rounded-[5px] text-sm mb-4 backdrop-blur font-clash-Regular text-[#FFFFFF] -tracking-tight leading-[100%] text-[24px] mt-28 max-sm:text-[18px] max-sm:px-3 max-sm:h-[36px] max-sm:py-[6px] max-sm:mt-[5.4rem] max-xl:text-[20px]">
          ...
          <p className="text-[#FFFFFF] font-inter-Regular text-[24px] leading-[32px] -tracking-tight text-center w-[730px] mt-4 max-sm:text-[14px] max-sm:w-[327px] px-2 max-sm:mt-2 max-sm:leading-[24px] max-sm:px-0 max-xl:text-[20px] max-xl:w-[530px]">
